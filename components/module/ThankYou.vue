...
import type { ThankYouModule } from '#imports';
...
<template>
    <section class="c-thank-you">
        <div class="top">
            <div class="svg">
                <svg width="129" height="94" viewBox="0 0 129 94" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M94 66.5L100.519 74.8333L113.556 56.5" stroke="#1CC286" stroke-width="1.5"/>
                </svg>
            </div>
            <div class="message">
                <h1 class="title | t-subtitle"
                    v-if="!isEmpty(m.props.title.value)"
                    >
                    {{ m.props.title.value }}
                </h1>
                <p class="rich-text-simple"
        ...
        <div class="bottom">
            ...
            <div class="link-wrap">
                <a class="link-block" v-for="(b, i) in m.props.links.value"
                    :href="b.props.url.value" target="_blank" :key="i"
                    >
                    <div class="L">
                        <BuilderImage />
                    </div>
                    <div class="R">
                        <div class="title" v-if="!isEmpty(b.props.title.value)">
                            {{ b.props.title.value }}
                        </div>
...
<style lang="scss" src="/public/builder/scss/thank-you.scss" />
